            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-3">
                  ...
                  <span className="text-2xl font-headline">Concept Maps</span>
                </CardTitle>
                <CardDescription>
              ...
              <CardContent>
                <Accordion type="multiple" className="space-y-4">
                  {Array.isArray(conceptMaps) &&
                    conceptMaps.map((subject) => (
                      <AccordionItem
                        key={subject.subject}
                        value={subject.subject}
                        className="border rounded-lg"
                      >
                        <AccordionTrigger className="text-xl font-headline px-6">
                          {subject.subject}
                        </AccordionTrigger>
          ...
          <TabsContent value="theory" className="mt-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Chapter-wise theory, formulas and derivations.
                </CardDescription>
              </CardHeader>
                                    ...
                                    chapter.concepts.map((concept) => (
                                      ...
                                      >
                                        ...
                                        <CardContent className="space-y-4">
                                          ...
                                          {concept.formula && (
                                            <code className="block p-4 rounded bg-background border">
                                              {concept.formula}
                                            </code>
                                          )}
